	...
	return (
		<>
			...
			<div className="flex flex-row space-x-5 p-2">
				...
				<button onClick={() => makepurchase(item.nftContract, item.itemId, item.price)} className="inline-flex items-center bg-green-100 border-0 mt-4  px-3 focus:outline-none hover:bg-green-200 rounded text-sm font-bold md:mt-0">Buy</button>
			</div>
